...
public class CollectionSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collection_song);
    ...
    private void initView() {
        ...
        //页面公用标题头初始化
        View incView = findViewById(R.id.collection_header);
        ...
        tv_second.setText(getString(R.string.songCollection));
